  ...
  <div class="container text-center">
    <div class="row">
      ...
      <div class="columna col-12 col-md-4">        
        ...
        <p class="experiencia-descripcion">Página uteycv en la cual podrás subir tus constancias para acreditar la UA Electiva a mediados del ciclo escolar en curso.</p>
      </div>
      <!-- Calendario -->
      <div class="columna col-12 col-md-4">
